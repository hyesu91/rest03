...
// 페이지별 메타 (소스 page-head-title-wrap 반영)
const pages = {
  ethical: { headLabel: 'Ethical', en: 'Ethical Management', title: '윤리경영', slogan: '“투명하고 정직한 경영의 실천”' },
  safety: { headLabel: 'Safety', en: 'Safety Management', title: '안전경영', slogan: '“사람 중심의 안전 최우선 경영”' },
  quality: { headLabel: 'Quality', en: 'Quality Management', title: '품질경영', slogan: '“품질 경쟁력 강화로 고객감동 실현”' },
  csr: { headLabel: 'CSR', en: 'Social Contribution', title: '사회공헌', slogan: '“지역사회와 함께 성장하는 기업”' },
}

// 품질경영 방침 카드 (소스 .text-cnt-box)
        ...
        <div className="flex flex-wrap gap-6">
          {qualityPolicies.map((p) => (
            ...
            >
              ...
              <p className="mt-3 text-base font-medium leading-8 text-neutral-700">{p.desc}</p>
            </div>
          ))}
        </div>
      </section>
...
function GenericContent({ meta }) {
  return (
    <div className="mx-auto max-w-container px-4 md:px-10 lg:px-40">
      <p className="mb-16 text-5xl font-semibold leading-none text-brand md:text-7xl">{meta.en}</p>
  ...
  return (
    <SubPageLayout
      ...
      hero={{
        left: {
          tit: 'Sustainability',
          desc: '안전과 품질을 최우선으로 삼아 사람과 환경이 함께하는 지속가능한 성장을 이어갑니다.',
        },
        right: {
          tit: meta.title,
          slogan: meta.slogan,
